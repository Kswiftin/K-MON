...
- **ジム争奪戦** — 同じネットワークにひとつのジムを置いて競い、勝った人がジムリーダーになります。リーダーは防衛チーム4体を配置し、その4体は育成・ほかのバトル・交換から外れます。自分で戦うかAIに任せるか選べます。挑戦は挑戦者ごとに5分に1回で、対戦中は挑戦できず観戦のみになります。両者ともLv.50に補正され、防衛に成功するとほしのかけらを獲得します（3連続ごとにボーナス、1日の上限あり）。
...
- **ウェーブラン（プロトタイプ）** — 最初のポケモンを選び、12ウェーブに挑みます。4ウェーブごとにボスが現れ、ウェーブを突破するたびにアイテムを1つ選びます。野生のウェーブではモンスターボール（1ランに7個）を投げて相手を捕まえ、手持ちを6匹まで増やせます。9ウェーブからは相手が2匹ずつ現れます。ランは毎回新しく抽選され、1日の回数制限はありません。メモリ上にだけあるため、ウィンドウを閉じても続きますが、アプリを終了すると消えます。
...
<tr>
<td width="45%" align="center"><img src="assets/screenshot-outfit-ja.png" width="180" alt="きせかえ"><br><br><img src="assets/screenshot-run-ja.png" width="180" alt="ウェーブランの報酬選択"><br><br><img src="assets/screenshot-run-catch-ja.png" width="180" alt="ウェーブランの捕獲"></td>
<td width="55%" valign="middle">
<h3>きせかえとウェーブラン</h3>
トレーナーの衣装を着替え、ウェーブを突破するたびに報酬アイテムを1つ選びます。野生のウェーブでは捕獲成功率を見てからボールを投げます。
</td>
</tr>
</table>
