...
- **共闘レイド** — 同じネットワークのトレーナーと一緒に今日のボスを一体倒します。1★・3★はいつでも開けますが、5★は1日3回決まった時刻にだけ出現します(15分前に通知)。精算は貢献度・残りターン・生存者数で決まり、報酬は1日1回だけ受け取れます。
...
<td width="55%" valign="middle">
<h3>共闘レイド</h3>
同じネットワークのトレーナーと一緒に今日のボスを一体倒します。1★・3★はいつでも開け、5★は1日3回決まった時刻に出現します。近くに開いている部屋があれば一覧からすぐ参加できます。
</td>
</tr>
</table>
