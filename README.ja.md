...
- **共闘レイド** — 同じネットワークのトレーナーと協力し、正午の前後で異なるボスに挑みます。報酬は午前・午後に1回ずつ受け取れ、受け取り後も報酬なしで参加できます。失敗した挑戦は回数を消費しません。成功すると最後まで部屋に残った参加者ごとに(倒れても抜けていなければ対象)、高級25%・希少15%・伝説5%の確率でボスを捕獲し、チャットと一緒に結果が一人ずつ順番に表示されます。
...
<td width="55%" valign="middle">
<h3>共闘レイド</h3>
同じネットワークのトレーナーと一緒にボスを倒します。午前と午後で異なるボスが登場し、報酬はそれぞれの時間帯に1回受け取れます。1★・3★はいつでも開け、5★は1日3回決まった時刻に出現します。画面の下で連れていくポケモンを選べ、近くに開いている部屋があれば一覧からすぐ参加できます。
</td>
</tr>
<tr>
<td width="55%" valign="middle">
