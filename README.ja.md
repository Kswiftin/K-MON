...
<table>
<tr>
<td width="45%" align="center"><img src="assets/screenshot-home.gif" width="340" alt="集中タイマーと冒険操作があるホーム画面"></td>
...
<td width="45%" align="center"><img src="assets/screenshot-collection-pokedex.png" width="300" alt="図鑑"><br><br><img src="assets/screenshot-collection-catchlog.png" width="300" alt="ポケモンのコレクションログ"></td>
</tr>
<tr>
...
バトル申し込み用の通知と、LAN 検出用のローカルネットワークアクセスを、表示されたときに許可してください。
