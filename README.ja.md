...
- **ウェーブラン（プロトタイプ）** — 最初のポケモンを選び、12ウェーブに挑みます。4ウェーブごとにボスが現れ、ウェーブを突破するたびにアイテムを1つ選びます。1回のランはメモリ上にだけあり、ウィンドウを閉じても続きますが、アプリを終了すると消えます。
...
<tr>
<td width="45%" align="center"><img src="assets/screenshot-outfit-ja.png" width="180" alt="きせかえ"><br><br><img src="assets/screenshot-run-ja.png" width="180" alt="ウェーブランの報酬選択"></td>
<td width="55%" valign="middle">
<h3>きせかえとウェーブラン</h3>
トレーナーの衣装を着替え、ウェーブを突破するたびに報酬アイテムを1つ選びます。
</td>
</tr>
</table>
