...
- **Co-op raid** — team up with trainers on your network against a different boss before and after noon. Each half-day pays once; you may keep joining afterward without another reward, while a failed run consumes nothing. On a clear, every surviving runner independently catches the boss at 25% for uncommon, 15% for rare, or 5% for legendary raids, and the results are revealed one trainer at a time beside the chat.
...
Review your owned Pokémon, select a partner, check moves and experience, and see the species you have discovered. Search by name to pull a Pokémon straight out of the box, team picker, or trade list, or show only species for which you own duplicates. Pokémon pickers outside the roster are ordered alphabetically by name. Every species from Generations 1–9 is here, minus fourteen late Gen 9 ones that have no animated sprite. Star the ones you want to keep — a favorite cannot be released, traded, or listed on the market, and the header star narrows the box to favorites only.
</td>
