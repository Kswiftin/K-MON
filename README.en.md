...
- **Co-op raid** — team up with trainers on your network against a different boss before and after noon. Each half-day pays once; you may keep joining afterward without another reward, while a failed run consumes nothing. On a clear, every runner who stayed for the whole fight (fainted or not, as long as they didn't leave) independently catches the boss at 25% for uncommon, 15% for rare, or 5% for legendary raids, and the results are revealed one trainer at a time beside the chat.
