...
@Suite struct BonjourServiceDeclarationTests {
    ...
    @Test func everyServiceTypeInSourcesIsDeclaredInTheAppPlist() throws {
        ...
        #expect(sources.count > 10, "소스를 못 찾았다 — 경로가 깨지면 가드가 무력해진다")
        ...
        #expect(declaredTypes.count >= 5, "서비스 타입 스캔이 아무것도 못 찾았다")
