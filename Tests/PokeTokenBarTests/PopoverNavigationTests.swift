...
// 팝오버 내비게이션 계약 — 닫혔다 열릴 때 AppDelegate.togglePopover 가 prepareForReopen() 을
// 부른다. 접는 것은 **설정뿐**이다: 보던 탭과 진행 중 오버레이는 그대로 이어진다.
@MainActor
final class PopoverNavigationTests: XCTestCase {
    ...
    /// 던전(#79)은 설정·체육관과 같은 층이다 — 배틀 신청이 오면 접혀야 한다.
