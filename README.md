...
- **지닌 물건** — 배틀에서 쓰이는 지닌 물건 161종을 상점 '배틀' 탭에서 사서 포켓몬에게 들려 줍니다. 타입 강화 도구·열매·주얼·플레이트부터 생명의구슬·구애 계열·돌격조끼까지 있고, 물건마다 대가가 다릅니다. 무엇을 지녔는지는 포켓몬 상세 카드와 격자의 가방 표식으로 확인하고, 함께 다니는 포켓몬은 그 자리에서 벗길 수 있습니다. 레이드·체육관 등 대전 상대를 고르는 화면에서도 후보 포켓몬별로 지닌 물건을 보고 바로 장착·해제할 수 있습니다(활성이든 보관함이든 상관없습니다). 배틀 화면에서는 내 포켓몬의 물건만 보이고 상대의 것은 발동할 때 기록으로 드러납니다.
