...
- **협동 레이드** — 같은 네트워크의 트레이너들과 함께 보스를 잡습니다. 오전·오후로 나뉘고, 티어마다 다른 보스가 등장합니다 — 1★는 고급종, 3★는 희귀종, 5★는 전설. 성공 보상과 포획 기회는 시간대·티어마다 각각 한 번씩이라 하루 최대 여섯 번(오전 셋·오후 셋) 도전할 가치가 있습니다. 보상을 받은 뒤에도 다시 참가할 수 있고 실패한 판은 횟수를 쓰지 않습니다. 성공하면 끝까지 방에 남은 참가자마다(쓰러졌어도 나가지만 않았으면 포함) 고급 25%·희귀 15%·전설 5% 확률로 보스를 포획하며, 결과는 채팅과 함께 한 명씩 차례로 공개됩니다.
