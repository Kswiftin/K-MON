...
- **협동 레이드** — 같은 네트워크의 트레이너들과 함께 오늘의 보스 하나를 잡습니다. 1★·3★는 아무 때나 열 수 있고, 5★는 하루 세 번 정해진 시각에만 부화합니다(15분 전 알림). 정산은 기여도·남은 턴·생존자 수로 계산되며 지급은 하루 한 번입니다.
...
<td width="55%" valign="middle">
<h3>협동 레이드</h3>
같은 네트워크의 트레이너들과 오늘의 보스 하나를 함께 잡습니다. 1★·3★는 아무 때나 열고, 5★는 하루 세 번 정해진 시각에 부화합니다. 근처에 열린 방이 있으면 목록에서 바로 참가할 수 있습니다.
</td>
</tr>
</table>
