...
- **협동 레이드** — 같은 네트워크의 트레이너들과 함께 보스를 잡습니다. 오전과 오후에 서로 다른 보스가 등장하며, 성공 보상은 각 시간대에 한 번씩 받을 수 있습니다. 보상을 받은 뒤에도 다시 참가할 수 있고 실패한 판은 횟수를 쓰지 않습니다. 성공하면 끝까지 방에 남은 참가자마다(쓰러졌어도 나가지만 않았으면 포함) 고급 25%·희귀 15%·전설 5% 확률로 보스를 포획하며, 결과는 채팅과 함께 한 명씩 차례로 공개됩니다.
